 ...
 */
/* tslint:disable:no-unused-variable member-ordering */
class SupplyUploadRecordControllerService extends BaseService {
    httpClient;
    constructor(httpClient, basePath, configuration) {
        super(basePath, configuration);
        this.httpClient = httpClient;
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.14", ngImport: i0, type: SupplyUploadRecordControllerService, deps: [{ token: i1.HttpClient }, { token: BASE_PATH, optional: true }, { token: Configuration, optional: true }], target: i0.ɵɵFactoryTarget.Injectable });
...
const APIS = [AdminService, HistoryService, OrderService, OrdersService, OrdersControllerService, PrintersService, SuppliesTransitionService, SupplyService, SupplyTaskService, SupplyTransitionService, SupplyUploadRecordService, SupplyUploadRecordControllerService, TenantService, TenantsService, ToStockTransitionService];
...
export { APIS, AdminService, ApiModule, BASE_PATH, COLLECTION_FORMATS, Configuration, HistoryService, OrderDto, OrderService, OrdersControllerService, OrdersService, PersonDto, PrintersService, SuppliesTransitionService, SupplyDto, SupplyService, SupplyTaskService, SupplyTransitionService, SupplyUploadRecordControllerService, SupplyUploadRecordService, TenantService, TenantsService, ToStockTransitionService, provideApi };
